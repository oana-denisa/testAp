            ...
            .map(
                existingClient -> {
                    if (client.getNume() != null) {
                        existingClient.setNume(client.getNume());
                    }
                    if (client.getPrenume() != null) {
                        existingClient.setPrenume(client.getPrenume());
                    }
                    ...
                    if (client.getDisponibilitate() != null) {
                        existingClient.setDisponibilitate(client.getDisponibilitate());
                    }
