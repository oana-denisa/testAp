...
describe('Component Tests', () => {
  describe('Specializare Management Component', () => {
    let comp: SpecializareComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpecializareComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.specializares?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
