...
class ClientResourceIT {
    ...
    private static final Instant DEFAULT_DATA_NASTERE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATA_NASTERE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            ...
            .dataNastere(DEFAULT_DATA_NASTERE)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            ...
            .dataNastere(UPDATED_DATA_NASTERE)
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getNume()).isEqualTo(DEFAULT_NUME);
        assertThat(testClient.getPrenume()).isEqualTo(DEFAULT_PRENUME);
        assertThat(testClient.getDataNastere()).isEqualTo(DEFAULT_DATA_NASTERE);
        assertThat(testClient.getAdresa()).isEqualTo(DEFAULT_ADRESA);
        assertThat(testClient.getTelefon()).isEqualTo(DEFAULT_TELEFON);
        assertThat(testClient.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testClient.getDisponibilitate()).isEqualTo(DEFAULT_DISPONIBILITATE);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].dataNastere").value(hasItem(DEFAULT_DATA_NASTERE.toString())))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.dataNastere").value(DEFAULT_DATA_NASTERE.toString()))
    ...
    void putNewClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getNume()).isEqualTo(UPDATED_NUME);
        assertThat(testClient.getPrenume()).isEqualTo(UPDATED_PRENUME);
        assertThat(testClient.getDataNastere()).isEqualTo(UPDATED_DATA_NASTERE);
        assertThat(testClient.getAdresa()).isEqualTo(UPDATED_ADRESA);
        assertThat(testClient.getTelefon()).isEqualTo(UPDATED_TELEFON);
        assertThat(testClient.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testClient.getDisponibilitate()).isEqualTo(UPDATED_DISPONIBILITATE);
    }
